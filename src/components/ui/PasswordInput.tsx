    ...
    return (
      <div className="relative">
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 p-0.5 text-[var(--neutral-11)] hover:text-[var(--neutral-12)] focus:outline-none focus:text-[var(--neutral-12)] focus-visible:ring-2 focus-visible:ring-[var(--accent-9)] focus-visible:rounded transition-colors"
          tabIndex={0}
        >
