...
Fixed in [#13](https://github.com/openidle-dev/queryden/issues/13). The Database Explorer toggle moved to `Ctrl+\` (matching the VS Code / DataGrip sidebar-toggle convention), leaving `Ctrl+D` to Monaco's built-in "add selection to next occurrence" multi-cursor.
