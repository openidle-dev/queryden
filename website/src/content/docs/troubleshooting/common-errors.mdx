...
[Issue #9](https://github.com/openidle-dev/queryden/issues/9) — the global handler dispatches the wrong event name. Use `Ctrl+Shift+F` inside the editor instead, which is wired to Monaco's built-in formatter directly. Will be unified in a future release.
